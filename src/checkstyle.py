...
DISABLED_CHECKS = ['missing-docstring', 'no-else-return']
BASE_OPTIONS = "--const-naming-style=any"
PYTHON_EXTENSION = ".py"


def main(root=None, verbose=False, process_count=None):
    """
...
def run_linter(files, args):
    ...
    command = "{} {}".format(" ".join(files), get_options(args))
...
if __name__ == "__main__":
    ...
    main(root=parsed_args.root, process_count=parsed_args.parallel, verbose=parsed_args.verbose)
